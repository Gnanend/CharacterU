...
const Footer = () => {
  ...
  const sections = [
    {
      title: 'Platform',
      links: [
        { name: 'Character Creator', path: '#' },
        { name: 'Assets & Skins', path: '#' },
  ...
  return (
    <footer className="bg-dark-950 border-t border-dark-900 pt-16 pb-8 relative z-10">
      <Container>
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold tracking-tight text-white">
                Character<span className="text-primary-400">U</span>
              </span>
            </Link>
            <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
              Empowering creators and game developers with scalable, customizable, and next-generation character generators. Integrate flawlessly using our REST and GraphQL APIs.
            </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 text-xs text-slate-500">
          <p>© {currentYear} CharacterU. All rights reserved.</p>
